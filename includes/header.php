...
<div class="container" id="top-page">
	<header >
		<div class="hgroup text-center">
			<a href="index.php"><h1>Consistently Inconsistent</h1></a>
		</div>
		<a href="#" id="logo"></a>
		...
		<nav class="fancy text-center">
			...
			<a href="yoga.php"><span>Yoga</span><span>&amp; Zen</span></a>
			<a href="cooking.php"><span>Cooking</span><span>&amp; Healthy Living</span></a>
			<a href="cats.php"><span>Kittens</span><span>&amp; Mittens</span></a>
			<a href="contact.php"><span>Contact Me</span><span>&amp; About </span></a>
		</nav>
	</header>